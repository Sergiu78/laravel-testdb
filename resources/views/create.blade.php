        ...
        <div class="row">
            ...
            <form action="{{ route('item.store') }}" method="POST">
                ...
                <div class="form-group">
                  ...
                  <input type="text" name="productnumber" class="form-control" id="exampleFormControlInput1">
                </div>
                <div class="form-group">
                  <label>Price</label>
                ...
                <div class="form-group">
                  ...
                  <textarea name="shortdescr" class="summernote" id="FormControlTextarea1"  cols="150" rows="3"></textarea>
                </div>
                <div class="form-group">
                  <label for="FormControlTextarea2">Long description</label>
                  <textarea name="longdescr" class="summernote" id="summernote"  rows="3"></textarea>
                </div>
